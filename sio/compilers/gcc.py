...
class CCompiler(CStyleCompiler):
    ...
    def gcc_12_2_0_c17(cls):
        obj = cls('gcc.12_2_0')
        obj.options = ['-std=c17', '-static', '-O3', '-lm', '-s']
        return obj
...
def run_gplusplus10_2_cpp17_amd64(environ):
    return CPPCompiler.gcc_10_2_cpp17_amd64().compile(environ)
